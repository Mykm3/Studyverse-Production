...
export default function LoginScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isLoginMode) {
        ...
        console.log('[LoginScreen] Attempting registration for:', email);
        await register(email, password, displayName);
      }
    } catch (error) {
      console.error('[LoginScreen] Authentication failed:', error);
  ...
  return (
    ...
    >
      ...
      >
        <Image
          source={require('@/assets/images/Studyverse_Logo3.png')}
